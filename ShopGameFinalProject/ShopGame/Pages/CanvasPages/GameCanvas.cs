...
namespace ShopGame.Pages
{
    class GameCanvas : Canvas
    {
        ...
        {
            player.Screen.ScreenState = ScreenStateEnum.BuyShop;
        }
        ...
        public void CreateScreenOverlay()
        {
            ...
            shop.delegatedMethod = OpenShop;
            buttons.Add(shop);

            shop = new Button(Game, "Crafting Requests");
            shop.CreateButton("Crafting Request", new Vector2(20, 0 + text.TextPositions($"1").Y * 9), Color.White, Color.Black);
            shop.delegatedMethod = OpenBuyShop;
            buttons.Add(shop);
        }
